...
대금 지급 전에 제한세율 적용신청서를 수령하여야 한다.

해당 문서는 파일 첨부하였음.

로열티 소득은 소득세법 제 119조 10호 사용료소득에 해당되어 국내원천소득으로 과세됨


택스 관련하여 해당 문서를 먼저 받아야 처리가 가능하다고 합니다.

Q1. 해당 문서를 먼저 받을 수 있을까요?

Q2. 세금 국내원천징수를 하여 회계팀 말로는 택스를 제외한 비용을 입금하면 된다고 하는데 맞는지 확인 부탁한다.
    (Tax Rate 는 11%로 알고 있다. 12000 * 0.89 =  10,680
